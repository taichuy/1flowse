...
- 初期安全红线应固定为：
  ...
  - `HostExtension` 若存在，只允许官方或白名单且按宿主启动生命周期加载，不做热卸载
