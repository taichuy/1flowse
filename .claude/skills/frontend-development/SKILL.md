...
description: |
  Use when building or changing 1Flowse frontend pages, workspace flows, interactions, visual structure, or component boundaries and need to preserve the project's page recipes, interaction contracts, and UI consistency
---
