...
description: 用于 7Flows 一轮实现、文档或 skill 调整接近完成时，统一收尾验证、文档同步、Git 提交和下一步规划，避免遗漏 history / runtime-foundation / team-conventions / ADR 等开发闭环。
---
...
- 需要确认是否补 `docs/history/`、`docs/dev/runtime-foundation.md`、`docs/dev/team-conventions.md`、`docs/adr/`
...
- 跨回合需要长期保留背景 / 决策 / 后果的规则：更新 `docs/adr/`
