...
- `docs/.private/`：当前开发者自己的本地私有笔记目录，默认不进 Git，也不作为仓库事实入口
...
- New shared governance docs, ADRs, skills, and newly added standing repo rules should now be authored in English; legacy Chinese docs can be migrated incrementally.
