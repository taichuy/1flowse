...
#[openapi(
    paths(
        ...
        crate::routes::model_providers::update_routing,
    ...
    components(schemas(
        ...
        crate::routes::model_providers::ModelProviderRoutingResponse,
        ...
        crate::routes::model_providers::UpdateModelProviderRoutingBody,
